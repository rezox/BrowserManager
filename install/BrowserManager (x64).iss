...
#define OutputBaseFilename StringChange(AppName, ' ', '') + '-' + AppVersion + '-x64'
...
Root: HKCR; Subkey: "BrowserManagerURL"; ValueType: string; ValueName: ""; ValueData: "BrowserManager URL"; Flags: uninsdeletekey
